    ...
    <v-form class="ma-6">
      <v-row align="center">
        ...
        <v-col
          ...
          md="3"
        >
          <label class="text-left"> CF-{{ ContractEditForm.id }}</label>
          <!-- <v-text-field
            id="contract_id"
...
<script>
import {
  mdiPlus, mdiPencil, mdiMinusCircle, mdiPageNextOutline,
} from '@mdi/js'
...
export default {
  ...
  methods: {
    ...
    submit(ContractEditForm) {
      ...
      ContractEditForm.contract_details.map(v => v.material_id).sort().sort((a, b) => {
