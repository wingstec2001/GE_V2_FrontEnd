...
export default {
  ...
  computed: {
    ...mapState('blenderStore', ['selectedBlender']),
  },
  methods: {
    ...mapMutations('app', ['setOverlayStatus']),
    ...mapActions('blenderStore', ['deleteBlender', 'loadBlender']),
    deleteItem(item) {
      this.apierror.messages = []
      this.submitStatus = true
      this.deleteBlender(item.id)
        .then(() => {
    ...
    openForm() {
      ...
      this.loadBlender(this.id)
        .then(() => {
          this.item = { ...this.selectedBlender }
