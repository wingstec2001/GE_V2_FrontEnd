...
export default {
  ...
  methods: {
    ...
    ...mapActions('arrivalactualStore', ['deleteArrivalDetail', 'loadArrivalActualDetail']),
    deleteItem(item) {
      this.apierror.messages = []
      this.submitStatus = true
      this.deleteArrivalDetail(item.aad_id)
        .then(() => {
    ...
    openForm() {
      ...
      this.loadArrivalActualDetail(this.aadId)
        .then(() => {
          this.item = { ...this.selectedArrivalDetail }

          this.item.material_name = this.selectedArrivalDetail.material
            ? this.selectedArrivalDetail.material.material_name
            : ''
