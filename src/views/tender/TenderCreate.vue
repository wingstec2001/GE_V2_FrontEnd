...
export default {
  ...
  computed: {
    ...
    descErrors() {
      ...
      // eslint-disable-next-line no-unused-expressions
      !this.$v.BidForm.bid_desc.maxLength && errors.push('100文字以内にして下さい。')
  ...
  mounted() {
    ...
    this.BidForm.bid_id = this.$getUniqueId(10, 'B')
  },
  methods: {
    ...mapActions('productStore', ['loadProductIds']),
    ...mapActions('bidStore', ['createBid']),
