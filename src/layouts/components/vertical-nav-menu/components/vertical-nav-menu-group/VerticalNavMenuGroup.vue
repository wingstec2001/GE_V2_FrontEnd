...
import VerticalNavMenuSectionTitle from '../vertical-nav-menu-section-title/VerticalNavMenuSectionTitle.vue'
...
@import '@/plugins/vuetify/default-preset/preset/variables.scss';
